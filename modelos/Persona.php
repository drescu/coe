...
class Persona {
    ...
    {
        $sql = "UPDATE personas SET tipo_doc='$tipo_doc', numero_doc='$numero_doc', nombre='$nombre', 
    ...
    {
        $sql = "UPDATE personas SET condicion='0' WHERE idpersona='$idpersona'";
        return ejecutarConsulta($sql);       
    } 
    ...
    public function listar() 
    {
        $sql = "SELECT idpersona, nombre, apellido, tipo_doc, numero_doc
                FROM personas WHERE condicion=1";
        return ejecutarConsulta($sql);        
    }
